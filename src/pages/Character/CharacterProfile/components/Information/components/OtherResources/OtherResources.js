...
import useStyles from './OtherResources.styles';

export function OtherResources(props) {
            ...
            <Paper variant="outlined" className={classes.paper}>
                <Box component="span" className={classes.stat}>
                    <Box className={classes.subtitleContainer}>
                        <Box />
                        <Typography variant="subtitle2" className={classes.subtitle} >{'OTROS RECURSOS'}</Typography>
                        {props.editable ?
                            <IconButton size="small" onClick={addResource}>
                                <AddIcon />
                            </IconButton> : <Box />
                        }
                    </Box>
