    ...
    <div className={classes.root}>
      <Grid container spacing={1}>
        <Grid item container spacing={1} lg={8} xs={12}>
          ...
          <Grid item lg={4}>
            <Portrait image={character.portrait} changeFlavor={props.changeFlavor} editable={props.editable} />
          </Grid>
          ...
          <Grid container item lg={6} xs={12} style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {props.settings && props.settings.generalOptions.experience && (
              <Grid item lg={12}>
                <Experience editable={props.editable} />
              </Grid>
            )}
            {props.settings && props.settings.generalOptions.training && (
              <Grid item lg={12}>
                <Training editable={props.editable} />
              </Grid>
            )}
            <Grid item lg={12}>
              <PhysicalDescription
        ...
        <Grid item lg={4} xs={12} container spacing={1}>
          <Grid item lg={12} xs={12}>
            <Backstory story={character["backstory"]} changeFlavor={props.changeFlavor} editable={props.editable} />
          </Grid>
        </Grid>
      </Grid>
    </div>
