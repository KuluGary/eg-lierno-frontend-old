              ...
              {rows.map((row) => (
                <TableRow>
                  <TableCell className={classes.cell}>
                    <Typography style={{ fontSize: "11px", marginRight: ".5rem" }}>{row.label}</Typography>
                  </TableCell>
                  <TableCell>
                    {row.key === "pronoun" && (
                      <Select
                        ...
                        style={{ fontSize: 11 }}
                        onChange={(event) =>
                          props.changeFlavor("traits", { ...props.traits, [row.key]: event.target.value })
                        }
                      >
                    ...
                    {row.key !== "alignment" && row.key !== "name" && row.key !== "pronoun" && (
                      <TextField
                        style={{ marginTop: ".4rem", width: "95%" }}
                        disabled={!props.editable}
