...
function CharacterList(props) {
    ...
    const { data, isLoading, error } = useQuery(CHAR_LIST_QUERY);
    ...
    useEffect(() => {
        ...
        if (!props.characters) {
            if (
                data?.get_user_characters.characters &&
                !data?.get_user_characters.errors
            ) {
                apiChars["userCharacters"] =
                    data?.get_user_characters.characters;
            }

            if (
                data?.get_dm_characters.characters &&
                !data?.get_dm_characters.errors
            ) {
                    ...
                    <Paper variant="outlined">
                        ...
                        >
                            ...
                            >
                                ...
                                <Tab
                                    label="Personajes de mis Campañas"
                                    {...a11yProps(1)}
                                />
                            </Tabs>
                            <Box>
                        ...
                        <TabPanel value={value} index={0}>
                            {characters &&
                                characters.userCharacters?.length > 0 && (
                                    <CharacterTable
                        ...
                        <TabPanel value={value} index={1}>
                            {characters &&
                                characters.dmCharacters?.length > 0 && (
                                    <CharacterTable
