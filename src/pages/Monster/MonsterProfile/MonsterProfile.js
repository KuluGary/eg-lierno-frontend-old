...
function MonsterProfile(props) {
  ...
  useEffect(() => {
    if (!monsters) {
      Api.fetchInternal("/bestiary/" + match.params.id).then((res) => setMonster(res));
    } else {
  ...
  useEffect(() => {
    if (monster) {
      if (monster.createdBy === props.profile._id) {
        setEditable(true);
      }
    }
  }, [monster]);
                ...
                <Box>
                  <Box style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Box>
                      <IconButton
                        disabled={!editable}
                        onClick={() => props.history.push("/bestiary/add/" + monster._id)}
                      >
                        <EditIcon />
                      </IconButton>
                ...
                <Box>
                  ...
                  <Grid container spacing={1}>
                    <Stats
                      ...
                      modifiers={monster.stats.abilityScoreModifiers}
                    />
                  </Grid>
                  ...
                  <Box>
                    ...
                    {monster.stats.damageVulnerabilities.length > 0 && (
                      <Box>
                        <Typography className={classes.bold} variant={"subtitle2"} display="inline">
                    ...
                    {monster.stats.damageResistances.length > 0 && (
                      <Box>
                        <Typography className={classes.bold} variant={"subtitle2"} display="inline">
                    ...
                    {monster.stats.damageImmunities.length > 0 && (
                      <Box>
                        <Typography className={classes.bold} variant={"subtitle2"} display="inline">
                          {"Inmunidades al daño: "}
                        </Typography>
                    ...
                    {monster.stats.conditionImmunities.length > 0 && (
                      <Box>
                        <Typography className={classes.bold} variant={"subtitle2"} display="inline">
                    ...
                    <Box>
                      ...
                      {monster.stats.languages.length > 0 ? monster.stats.languages.join(", ") : "–"}
                    </Box>
                    <Box>
                      <Typography className={classes.bold} variant={"subtitle2"} display="inline">
                        {"Valor de desafío: "}
                  ...
                  {monster.stats.legendaryActions.length > 0 && (
                    <Box>
                      ...
                      <Divider className={classes.fullWidthDivier} />
                      <Box>{monster.stats.legendaryActionsDescription}</Box>
                      <Box>
