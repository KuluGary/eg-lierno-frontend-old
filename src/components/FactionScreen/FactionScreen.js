                        ...
                        {factionsToDisplay.length > 0 && factionsToDisplay
                            ...
                            .map(faction => (
                                <TableRow hover component={Link} to={'/factions/' + faction._id} className={classes.link}>
                                    ...
                                    <TableCell style={{ width: "7vw" }}>{faction.name}</TableCell>
                                    <TableCell align="center" style={{ width: "7vw" }}>{getMemberCount(faction.members)}</TableCell>
                                    {(width !== "xs" && width !== "sm") &&
                                        <>
...
export default connect(mapStateToProps, mapDispatchToProps)(FactionScreen);