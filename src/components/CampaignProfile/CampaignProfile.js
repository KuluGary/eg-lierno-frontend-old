...
function CampaignProfile(props) {
    ...
    const [categories] = useState(["Detalles", "Diario de campaña", "PNJs", "Mapas"]);
    ...
    function tabData() {
        switch (selectedCategory) {
            ...
            case 4: return <Grid item component={Paper} variant="outlined" xs={12}>4</Grid>
            case 5: return <Grid item component={Paper} variant="outlined" xs={12}>5</Grid>
        }
    }
